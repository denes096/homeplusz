...
@section('content')
    ...
    <!--
		...
		==============================================
		-->
    <div class="inner-banner-two inner-banner z-1 pt-160 lg-pt-130 pb-160 xl-pb-120 md-pb-80 position-relative" style="background-image: url(/images/media/img_49.jpg);"> <!-- Project képek-->
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h3 class="py-5 fs-6 text-white">{{ $project->name }} Projekt Lista</h3>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container container-large">
            <div class="position-relative z-1">
                <div class="title-one mb-60 lg-mb-40 wow fadeInUp d-flex justify-content-between">
                    <h2 class="fs-6 col-6">{{ $project->name }} Projekt Lista</h2>
                </div>
                <!-- /.title-one -->
