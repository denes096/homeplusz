...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route($updateRoute, $client->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="tab-pane fade show active" id="basic" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('mobile') is-invalid @enderror" id="mobile" name="mobile" value="{{ old('mobile', $client->mobile) }}">
                                @error('mobile')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('user_id') is-invalid @enderror" id="user_id" name="user_id">
                                    ...
                                    <option value="{{ $id }}" {{ old('user_id', $client->user_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                                @error('user_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                    <option value="Aktív" {{ old('status', $client->status) == 'Aktív' ? 'selected' : '' }}>Aktív</option>
                                    <option value="Felfüggesztve" {{ old('status', $client->status) == 'Felfüggesztve' ? 'selected' : '' }}>Felfüggesztve</option>
                                    <option value="Archív" {{ old('status', $client->status) == 'Archív' ? 'selected' : '' }}>Archív</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="tab-pane fade" id="address" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('country') is-invalid @enderror" id="country" name="country" value="{{ old('country', $client->country ?: 'Magyarország') }}">
                                @error('country')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('contact_position') is-invalid @enderror" id="contact_position" name="contact_position" value="{{ old('contact_position', $client->contact_position) }}">
                    ...
                    <div class="tab-pane fade" id="other" role="tabpanel">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="5">{{ old('notes', $client->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (uploadDocumentBtn) {
        uploadDocumentBtn.addEventListener('click', function() {
            ...
            const formData = new FormData();
            formData.append('document_name', document.getElementById('document-name').value || file.name);
