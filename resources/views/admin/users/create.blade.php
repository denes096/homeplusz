                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="basic" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="password_confirmation" class="form-label">Jelszó megerősítése <span class="text-danger">*</span></label>
                                ...
                                <div class="border rounded p-3" style="max-height: 400px; overflow-y: auto;">
                                    @foreach($roles as $role)
                                        <div class="form-check mb-2">
                                            <input class="form-check-input role-checkbox" type="checkbox" name="roles[]" value="{{ $role->id }}" id="role_{{ $role->id }}" {{ old('roles') && in_array($role->id, old('roles')) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @foreach($perms as $permission)
                                                <div class="form-check ms-3">
                                                    <input class="form-check-input permission-checkbox" type="checkbox" name="permissions[]" value="{{ $permission->id }}" id="perm_{{ $permission->id }}" {{ old('permissions') && in_array($permission->id, old('permissions')) ? 'checked' : '' }}>
