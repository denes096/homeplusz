...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-12">
                <h2 class="mb-4">Felhasználók áttekintése</h2>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-3">
                    <div class="card bg-primary text-white">
                        <div class="card-body">
                            <h5 class="card-title">Összes felhasználó</h5>
                ...
                <div class="col-md-3">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <h5 class="card-title">Összes ingatlan</h5>
                            <h2 class="card-text">{{ $stats['total_properties'] }}</h2>
                ...
                <div class="col-md-3">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <h5 class="card-title">Összes projekt</h5>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    <div class="card bg-warning text-white">
                        <div class="card-body">
                            <h5 class="card-title">Összes partner</h5>
                            <h2 class="card-text">{{ $stats['total_partners'] }}</h2>
                ...
                <div class="col-md-6">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <h5 class="card-title">Összes rekord</h5>
                            <h2 class="card-text">{{ $stats['total_properties'] + $stats['total_projects'] + $stats['total_customers'] + $stats['total_partners'] }}</h2>
                            <i class="fas fa-database fa-2x"></i>
                            <small class="d-block mt-2">Minden adat összesen</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Felhasználók és statisztikáik</h4>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ backpack_url('property?user_id=' . $user['id']) }}"
                                    ...
                                    <td>
                                        <a href="{{ backpack_url('project?user_id=' . $user['id']) }}"
                                    ...
                                    <td>
                                        <a href="{{ backpack_url('customers?refId=' . $user['id']) }}"
                                    ...
                                    <td>
                                        <a href="{{ backpack_url('partners?user_id=' . $user['id']) }}"
                                    ...
                                    <td>
                                        <span class="badge {{ $user['total_count'] > 0 ? 'bg-primary' : 'bg-secondary' }} fs-6">
                                            {{ $user['total_count'] }}
                                        </span>
                                    </td>
                                    <td>
